...
export function ProgressDash() {
  ...
  const counts = useMemo(() => {
    ...
    return { todo, doing, done, total: tasks.length, ratio: done / total };
  }, [tasks]);
  ...
  return (
    <div className="grid h-full grid-cols-2 gap-3 rounded-2xl border border-[var(--line)] bg-[var(--bg-1)] p-4">
      <Card
        Icon={FiCircle}
